...
/// <summary>
/// Abstraction for document sources (OneDrive, S3, local files, Dropbox, RSS, etc.).
/// Implementations can be registered as plugins.
/// </summary>
public interface IDocumentProvider
{
    ...
    /// <summary>
    /// Downloads a document as a stream for processing.
    /// </summary>
